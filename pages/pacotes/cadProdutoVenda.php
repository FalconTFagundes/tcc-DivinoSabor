        ...
        if ($totalPacotes > 0) {
            ...
            try {
                ...
                foreach ($idProdutos as $index => $idproduto) {
                    ...
                    $sqlCadastrarProdutoNoPacote = $conexao->prepare("INSERT INTO pacotecadastro (idpacote, idproduto, quantidade, cadastro, ativo) VALUES (?, ?, ?, NOW(), 'A')");
                    ...
                    $valorPacote += $valorProduto * $quantidade;
                }
