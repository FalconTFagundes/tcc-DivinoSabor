...
try {
    ...
    if ($conn) {
        ...
        $query_eventos = "SELECT idingredientes, nomeIngred, quantIngred, pesoUnit, dataComp, precoUnit, precoTot, dataValidad, cadastro, alteracao, ativo FROM ingredientes";
        // Prepara a QUERY
    ...
    td {
        ...
        $dados .= "</head>";
        $dados .= "<body>";
        $dados .= "<h1>RELATÓRIO INGREDIENTES CADASTRADOS</h1>";
